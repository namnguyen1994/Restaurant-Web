<?php
/**
 * Geritcht\Geritcht\Customizer\Component class
 *
 * @package geritcht
 */

namespace Geritcht\Geritcht\Customizer;
...
class Component implements Component_Interface {
	...
	public function action_customize_register( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_section(
			'theme_options',
			array(
				'title'    => __( 'Theme Options', 'geritcht' ),
	...
	public function action_enqueue_customize_preview_js() {
		wp_enqueue_script(
			...
			array( 'jquery' ),
			geritcht()->get_asset_version( get_theme_file_path( '/assets/js/customizer.min.js' ) ),
			true
		);
	}
}
