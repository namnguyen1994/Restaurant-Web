...
/**
 * Geritcht\Geritcht\Sidebars\Component class
 *
 * @package geritcht
 */

namespace Geritcht\Geritcht\Sidebars;
 ...
 * * `geritcht()->is_primary_sidebar_active()`
 * * `geritcht()->display_primary_sidebar()`
 *
...
class Component implements Component_Interface, Templating_Component_Interface
{
	...
	public function action_register_sidebars()
	{
		register_sidebar(
			array(
				'name' => esc_html__('Blog Sidebar', 'geritcht'),
				'id' => static::PRIMARY_SIDEBAR_SLUG,
				'description' => esc_html__('Add widgets here.', 'geritcht'),
	...
	{
		$this->get_option =  get_option('geritcht-options');
